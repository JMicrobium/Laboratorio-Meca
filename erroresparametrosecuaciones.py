...
af=(As/60)**(1/2)#error medio A
bf=(Bs/60)**(1/2)#error medio B
cf=(Cs/60)**(1/2)#error medio C

"errores"
e_a1=((af)*(61**(1/2)))/((61*(l))-(s**2))
e_a0= (e_a1)*((l/61)**(1/2))
e_b1= ((bf)*(61**(1/2)))/((61*(l))-(s**2))
e_b0= (e_b1)*((l/61)**(1/2))
e_c1= ((cf)*(61**(1/2)))/((61*(l))-(s**2))
e_c0= (e_c1)*((l/61)**(1/2))
print("errorA===>","1:",e_a1,"0:",e_a0,"errorB===>","1:",e_b1,"0:",e_b0,"errorC===>","1:",e_c1,"0:",e_c0)#correción lista
